...
{{
var G__27684 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27684;
continue;
}
} else
...
{var pred__27688 = cljs.core._EQ_;var expr__27689 = limit;if(cljs.core.truth_(pred__27688.call(null,(1),expr__27689)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27688.call(null,(2),expr__27689)))
...
var G__27691 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27692 = (limit__$1 - (1));
var G__27693 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27691;
limit__$1 = G__27692;
parts = G__27693;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27695 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27695))
{var replacement_27696 = temp__4124__auto___27695;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27696)));
} else
{buffer.append(ch);
}
{
var G__27697 = (index + (1));
index = G__27697;
continue;
}
}

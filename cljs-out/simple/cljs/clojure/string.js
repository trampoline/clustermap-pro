...
{{
var G__27429 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27429;
continue;
}
} else
...
{var pred__27433 = cljs.core._EQ_;var expr__27434 = limit;if(cljs.core.truth_(pred__27433.call(null,(1),expr__27434)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27433.call(null,(2),expr__27434)))
...
var G__27436 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27437 = (limit__$1 - (1));
var G__27438 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27436;
limit__$1 = G__27437;
parts = G__27438;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27440 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27440))
{var replacement_27441 = temp__4124__auto___27440;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27441)));
} else
{buffer.append(ch);
}
{
var G__27442 = (index + (1));
index = G__27442;
continue;
}
}

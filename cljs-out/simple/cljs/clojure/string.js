...
{{
var G__27658 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27658;
continue;
}
} else
...
{var pred__27662 = cljs.core._EQ_;var expr__27663 = limit;if(cljs.core.truth_(pred__27662.call(null,(1),expr__27663)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27662.call(null,(2),expr__27663)))
...
var G__27665 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27666 = (limit__$1 - (1));
var G__27667 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27665;
limit__$1 = G__27666;
parts = G__27667;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27669 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27669))
{var replacement_27670 = temp__4124__auto___27669;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27670)));
} else
{buffer.append(ch);
}
{
var G__27671 = (index + (1));
index = G__27671;
continue;
}
}

...
{{
var G__27646 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27646;
continue;
}
} else
...
{var pred__27650 = cljs.core._EQ_;var expr__27651 = limit;if(cljs.core.truth_(pred__27650.call(null,(1),expr__27651)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27650.call(null,(2),expr__27651)))
...
var G__27653 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27654 = (limit__$1 - (1));
var G__27655 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27653;
limit__$1 = G__27654;
parts = G__27655;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27657 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27657))
{var replacement_27658 = temp__4124__auto___27657;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27658)));
} else
{buffer.append(ch);
}
{
var G__27659 = (index + (1));
index = G__27659;
continue;
}
}

...
{{
var G__27414 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27414;
continue;
}
} else
...
{var pred__27418 = cljs.core._EQ_;var expr__27419 = limit;if(cljs.core.truth_(pred__27418.call(null,(1),expr__27419)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27418.call(null,(2),expr__27419)))
...
var G__27421 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27422 = (limit__$1 - (1));
var G__27423 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27421;
limit__$1 = G__27422;
parts = G__27423;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27425 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27425))
{var replacement_27426 = temp__4124__auto___27425;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27426)));
} else
{buffer.append(ch);
}
{
var G__27427 = (index + (1));
index = G__27427;
continue;
}
}

...
{{
var G__27563 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27563;
continue;
}
} else
...
{var pred__27567 = cljs.core._EQ_;var expr__27568 = limit;if(cljs.core.truth_(pred__27567.call(null,(1),expr__27568)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27567.call(null,(2),expr__27568)))
...
var G__27570 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27571 = (limit__$1 - (1));
var G__27572 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27570;
limit__$1 = G__27571;
parts = G__27572;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27574 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27574))
{var replacement_27575 = temp__4124__auto___27574;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27575)));
} else
{buffer.append(ch);
}
{
var G__27576 = (index + (1));
index = G__27576;
continue;
}
}

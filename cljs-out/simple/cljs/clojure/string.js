...
{{
var G__23403 = cljs.core.pop.call(null,v__$1);
v__$1 = G__23403;
continue;
}
} else
...
{var pred__23407 = cljs.core._EQ_;var expr__23408 = limit;if(cljs.core.truth_(pred__23407.call(null,(1),expr__23408)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__23407.call(null,(2),expr__23408)))
...
var G__23410 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__23411 = (limit__$1 - (1));
var G__23412 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__23410;
limit__$1 = G__23411;
parts = G__23412;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___23414 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___23414))
{var replacement_23415 = temp__4124__auto___23414;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_23415)));
} else
{buffer.append(ch);
}
{
var G__23416 = (index + (1));
index = G__23416;
continue;
}
}

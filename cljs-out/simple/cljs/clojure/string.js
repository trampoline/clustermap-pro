...
{{
var G__27686 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27686;
continue;
}
} else
...
{var pred__27690 = cljs.core._EQ_;var expr__27691 = limit;if(cljs.core.truth_(pred__27690.call(null,(1),expr__27691)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27690.call(null,(2),expr__27691)))
...
var G__27693 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27694 = (limit__$1 - (1));
var G__27695 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27693;
limit__$1 = G__27694;
parts = G__27695;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27697 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27697))
{var replacement_27698 = temp__4124__auto___27697;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27698)));
} else
{buffer.append(ch);
}
{
var G__27699 = (index + (1));
index = G__27699;
continue;
}
}

...
{{
var G__27786 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27786;
continue;
}
} else
...
{var pred__27790 = cljs.core._EQ_;var expr__27791 = limit;if(cljs.core.truth_(pred__27790.call(null,(1),expr__27791)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27790.call(null,(2),expr__27791)))
...
var G__27793 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27794 = (limit__$1 - (1));
var G__27795 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27793;
limit__$1 = G__27794;
parts = G__27795;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27797 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27797))
{var replacement_27798 = temp__4124__auto___27797;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27798)));
} else
{buffer.append(ch);
}
{
var G__27799 = (index + (1));
index = G__27799;
continue;
}
}

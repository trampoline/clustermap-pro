...
{{
var G__27791 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27791;
continue;
}
} else
...
{var pred__27795 = cljs.core._EQ_;var expr__27796 = limit;if(cljs.core.truth_(pred__27795.call(null,(1),expr__27796)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27795.call(null,(2),expr__27796)))
...
var G__27798 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27799 = (limit__$1 - (1));
var G__27800 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27798;
limit__$1 = G__27799;
parts = G__27800;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27802 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27802))
{var replacement_27803 = temp__4124__auto___27802;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27803)));
} else
{buffer.append(ch);
}
{
var G__27804 = (index + (1));
index = G__27804;
continue;
}
}

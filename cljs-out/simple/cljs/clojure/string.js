...
{{
var G__23595 = cljs.core.pop.call(null,v__$1);
v__$1 = G__23595;
continue;
}
} else
...
{var pred__23599 = cljs.core._EQ_;var expr__23600 = limit;if(cljs.core.truth_(pred__23599.call(null,(1),expr__23600)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__23599.call(null,(2),expr__23600)))
...
var G__23602 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__23603 = (limit__$1 - (1));
var G__23604 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__23602;
limit__$1 = G__23603;
parts = G__23604;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___23606 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___23606))
{var replacement_23607 = temp__4124__auto___23606;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_23607)));
} else
{buffer.append(ch);
}
{
var G__23608 = (index + (1));
index = G__23608;
continue;
}
}

...
{{
var G__27197 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27197;
continue;
}
} else
...
{var pred__27201 = cljs.core._EQ_;var expr__27202 = limit;if(cljs.core.truth_(pred__27201.call(null,(1),expr__27202)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27201.call(null,(2),expr__27202)))
...
var G__27204 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27205 = (limit__$1 - (1));
var G__27206 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27204;
limit__$1 = G__27205;
parts = G__27206;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27208 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27208))
{var replacement_27209 = temp__4124__auto___27208;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27209)));
} else
{buffer.append(ch);
}
{
var G__27210 = (index + (1));
index = G__27210;
continue;
}
}

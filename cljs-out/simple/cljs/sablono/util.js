...
sablono.util.ToString = (function (){var obj26676 = {};return obj26676;
})();
...
sablono.util.ToURI = (function (){var obj26678 = {};return obj26678;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__26679){
var xs = cljs.core.seq(arglist__26679);
...
{var vec__26681 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__26681,(0),null);var words = cljs.core.nthnext.call(null,vec__26681,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__26683 = clojure.set.rename_keys.call(null,m,kmap);var G__26683__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__26683,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__26683);return G__26683__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__26684_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__26684_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26684_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__26684_SHARP_))
{return p1__26684_SHARP_;
} else
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26684_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__26685){
var maps = cljs.core.seq(arglist__26685);
...
*/
sablono.util.normalize_element = (function normalize_element(p__26690){var vec__26693 = p__26690;var tag = cljs.core.nth.call(null,vec__26693,(0),null);var content = cljs.core.nthnext.call(null,vec__26693,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__26694 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__26694,(0),null);var id = cljs.core.nth.call(null,vec__26694,(1),null);var class$ = cljs.core.nth.call(null,vec__26694,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))

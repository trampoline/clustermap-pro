...
sablono.util.ToString = (function (){var obj26664 = {};return obj26664;
})();
...
sablono.util.ToURI = (function (){var obj26666 = {};return obj26666;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__26667){
var xs = cljs.core.seq(arglist__26667);
...
{var vec__26669 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__26669,(0),null);var words = cljs.core.nthnext.call(null,vec__26669,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__26671 = clojure.set.rename_keys.call(null,m,kmap);var G__26671__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__26671,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__26671);return G__26671__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__26672_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__26672_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26672_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__26672_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__26673){
var maps = cljs.core.seq(arglist__26673);
...
*/
sablono.util.normalize_element = (function normalize_element(p__26678){var vec__26681 = p__26678;var tag = cljs.core.nth.call(null,vec__26681,(0),null);var content = cljs.core.nthnext.call(null,vec__26681,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__26682 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__26682,(0),null);var id = cljs.core.nth.call(null,vec__26682,(1),null);var class$ = cljs.core.nth.call(null,vec__26682,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))

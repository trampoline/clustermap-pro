...
{var iter__4377__auto__ = (function iter__28154(s__28155){return (new cljs.core.LazySeq(null,(function (){var s__28155__$1 = s__28155;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__28155__$1);if(temp__4126__auto__)
{var s__28155__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__28155__$2))
{var c__4375__auto__ = cljs.core.chunk_first.call(null,s__28155__$2);var size__4376__auto__ = cljs.core.count.call(null,c__4375__auto__);var b__28157 = cljs.core.chunk_buffer.call(null,size__4376__auto__);if((function (){var i__28156 = (0);while(true){
if((i__28156 < size__4376__auto__))
{var path__$1 = cljs.core._nth.call(null,c__4375__auto__,i__28156);cljs.core.chunk_append.call(null,b__28157,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28157),iter__28154.call(null,cljs.core.chunk_rest.call(null,s__28155__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28157),null);
}
} else
{var path__$1 = cljs.core.first.call(null,s__28155__$2);return cljs.core.cons.call(null,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
{var sp = temp__4126__auto____$1;return cljs.core.get_in.call(null,cursor,clustermap.components.mount.make_sequential.call(null,path__$1));
} else
{return null;
}
})(),iter__28154.call(null,cljs.core.rest.call(null,s__28155__$2)));
}
} else
{return null;
}
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4377__auto__ = (function iter__28158(s__28159){return (new cljs.core.LazySeq(null,(function (){var s__28159__$1 = s__28159;while(true){
...
{var vec__28164 = cljs.core._nth.call(null,c__4375__auto__,i__28160);var key = cljs.core.nth.call(null,vec__28164,(0),null);var path__$1 = cljs.core.nth.call(null,vec__28164,(1),null);cljs.core.chunk_append.call(null,b__28161,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
...
{var vec__28165 = cljs.core.first.call(null,s__28159__$2);var key = cljs.core.nth.call(null,vec__28165,(0),null);var path__$1 = cljs.core.nth.call(null,vec__28165,(1),null);return cljs.core.cons.call(null,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
{var sp = temp__4126__auto____$1;return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,cljs.core.get_in.call(null,cursor,sp)], null);
} else
{return null;
}
})(),iter__28158.call(null,cljs.core.rest.call(null,s__28159__$2)));
}
} else
{return null;
}
...
var mount__delegate = function (cname,f,value,p__28168){var map__28170 = p__28168;var map__28170__$1 = ((cljs.core.seq_QMARK_.call(null,map__28170))?cljs.core.apply.call(null,cljs.core.hash_map,map__28170):map__28170);var options = map__28170__$1;var paths = cljs.core.get.call(null,map__28170__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));var path = cljs.core.get.call(null,map__28170__$1,new cljs.core.Keyword(null,"path","path",-188191168));var target = cljs.core.get.call(null,map__28170__$1,new cljs.core.Keyword(null,"target","target",253001721));var target__$1 = (((typeof target === 'string') || ((target instanceof cljs.core.Keyword)))?document.getElementById(cljs.core.name.call(null,target)):target);var cursor_fn = cljs.core.partial.call(null,clustermap.components.mount.extract_paths,cname,path,paths);var options__$1 = cljs.core.assoc.call(null,cljs.core.assoc.call(null,cljs.core.dissoc.call(null,options,new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"paths","paths",-1807389588)),new cljs.core.Keyword(null,"target","target",253001721),target__$1),new cljs.core.Keyword(null,"fn","fn",-1175266204),cursor_fn);if(cljs.core.truth_(target__$1))
...
var p__28168 = null;if (arguments.length > 3) {
  p__28168 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);} 
return mount__delegate.call(this,cname,f,value,p__28168);};
mount.cljs$lang$maxFixedArity = 3;
mount.cljs$lang$applyTo = (function (arglist__28171){
var cname = cljs.core.first(arglist__28171);
arglist__28171 = cljs.core.next(arglist__28171);
var f = cljs.core.first(arglist__28171);
arglist__28171 = cljs.core.next(arglist__28171);
var value = cljs.core.first(arglist__28171);
var p__28168 = cljs.core.rest(arglist__28171);
return mount__delegate(cname,f,value,p__28168);
});
...
var unmount__delegate = function (p__28172){var map__28174 = p__28172;var map__28174__$1 = ((cljs.core.seq_QMARK_.call(null,map__28174))?cljs.core.apply.call(null,cljs.core.hash_map,map__28174):map__28174);var target = cljs.core.get.call(null,map__28174__$1,new cljs.core.Keyword(null,"target","target",253001721));var name = cljs.core.get.call(null,map__28174__$1,new cljs.core.Keyword(null,"name","name",1843675177));var target__$1 = (((typeof target === 'string') || ((target instanceof cljs.core.Keyword)))?document.getElementById(name.call(null,target)):target);if(cljs.core.truth_(target__$1))
...
var p__28172 = null;if (arguments.length > 0) {
  p__28172 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return unmount__delegate.call(this,p__28172);};
unmount.cljs$lang$maxFixedArity = 0;
unmount.cljs$lang$applyTo = (function (arglist__28175){
var p__28172 = cljs.core.seq(arglist__28175);
return unmount__delegate(p__28172);
});

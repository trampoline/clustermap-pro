...
{var iter__4377__auto__ = (function iter__28226(s__28227){return (new cljs.core.LazySeq(null,(function (){var s__28227__$1 = s__28227;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__28227__$1);if(temp__4126__auto__)
{var s__28227__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__28227__$2))
{var c__4375__auto__ = cljs.core.chunk_first.call(null,s__28227__$2);var size__4376__auto__ = cljs.core.count.call(null,c__4375__auto__);var b__28229 = cljs.core.chunk_buffer.call(null,size__4376__auto__);if((function (){var i__28228 = (0);while(true){
if((i__28228 < size__4376__auto__))
{var path__$1 = cljs.core._nth.call(null,c__4375__auto__,i__28228);cljs.core.chunk_append.call(null,b__28229,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28229),iter__28226.call(null,cljs.core.chunk_rest.call(null,s__28227__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28229),null);
}
} else
{var path__$1 = cljs.core.first.call(null,s__28227__$2);return cljs.core.cons.call(null,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
{var sp = temp__4126__auto____$1;return cljs.core.get_in.call(null,cursor,clustermap.components.mount.make_sequential.call(null,path__$1));
} else
{return null;
}
})(),iter__28226.call(null,cljs.core.rest.call(null,s__28227__$2)));
}
} else
{return null;
}
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4377__auto__ = (function iter__28230(s__28231){return (new cljs.core.LazySeq(null,(function (){var s__28231__$1 = s__28231;while(true){
...
{var vec__28236 = cljs.core._nth.call(null,c__4375__auto__,i__28232);var key = cljs.core.nth.call(null,vec__28236,(0),null);var path__$1 = cljs.core.nth.call(null,vec__28236,(1),null);cljs.core.chunk_append.call(null,b__28233,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
...
{var vec__28237 = cljs.core.first.call(null,s__28231__$2);var key = cljs.core.nth.call(null,vec__28237,(0),null);var path__$1 = cljs.core.nth.call(null,vec__28237,(1),null);return cljs.core.cons.call(null,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
{var sp = temp__4126__auto____$1;return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,cljs.core.get_in.call(null,cursor,sp)], null);
} else
{return null;
}
...
var mount__delegate = function (cname,f,value,p__28240){var map__28242 = p__28240;var map__28242__$1 = ((cljs.core.seq_QMARK_.call(null,map__28242))?cljs.core.apply.call(null,cljs.core.hash_map,map__28242):map__28242);var options = map__28242__$1;var paths = cljs.core.get.call(null,map__28242__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));var path = cljs.core.get.call(null,map__28242__$1,new cljs.core.Keyword(null,"path","path",-188191168));var target = cljs.core.get.call(null,map__28242__$1,new cljs.core.Keyword(null,"target","target",253001721));var target__$1 = (((typeof target === 'string') || ((target instanceof cljs.core.Keyword)))?document.getElementById(cljs.core.name.call(null,target)):target);var cursor_fn = cljs.core.partial.call(null,clustermap.components.mount.extract_paths,cname,path,paths);var options__$1 = cljs.core.assoc.call(null,cljs.core.assoc.call(null,cljs.core.dissoc.call(null,options,new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"paths","paths",-1807389588)),new cljs.core.Keyword(null,"target","target",253001721),target__$1),new cljs.core.Keyword(null,"fn","fn",-1175266204),cursor_fn);if(cljs.core.truth_(target__$1))
...
var p__28240 = null;if (arguments.length > 3) {
  p__28240 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);} 
return mount__delegate.call(this,cname,f,value,p__28240);};
mount.cljs$lang$maxFixedArity = 3;
mount.cljs$lang$applyTo = (function (arglist__28243){
var cname = cljs.core.first(arglist__28243);
arglist__28243 = cljs.core.next(arglist__28243);
var f = cljs.core.first(arglist__28243);
arglist__28243 = cljs.core.next(arglist__28243);
var value = cljs.core.first(arglist__28243);
var p__28240 = cljs.core.rest(arglist__28243);
return mount__delegate(cname,f,value,p__28240);
});
...
var unmount__delegate = function (p__28244){var map__28246 = p__28244;var map__28246__$1 = ((cljs.core.seq_QMARK_.call(null,map__28246))?cljs.core.apply.call(null,cljs.core.hash_map,map__28246):map__28246);var target = cljs.core.get.call(null,map__28246__$1,new cljs.core.Keyword(null,"target","target",253001721));var name = cljs.core.get.call(null,map__28246__$1,new cljs.core.Keyword(null,"name","name",1843675177));var target__$1 = (((typeof target === 'string') || ((target instanceof cljs.core.Keyword)))?document.getElementById(name.call(null,target)):target);if(cljs.core.truth_(target__$1))
...
var p__28244 = null;if (arguments.length > 0) {
  p__28244 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return unmount__delegate.call(this,p__28244);};
unmount.cljs$lang$maxFixedArity = 0;
unmount.cljs$lang$applyTo = (function (arglist__28247){
var p__28244 = cljs.core.seq(arglist__28247);
return unmount__delegate(p__28244);
});

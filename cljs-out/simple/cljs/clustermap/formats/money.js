...
var readable__delegate = function (n,p__23691){var map__23694 = p__23691;var map__23694__$1 = ((cljs.core.seq_QMARK_.call(null,map__23694))?cljs.core.apply.call(null,cljs.core.hash_map,map__23694):map__23694);var default$ = cljs.core.get.call(null,map__23694__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var plus_QMARK_ = cljs.core.get.call(null,map__23694__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327));var curr = cljs.core.get.call(null,map__23694__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"\u00A3");var sf = cljs.core.get.call(null,map__23694__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738));if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{var vec__23695 = clustermap.formats.number.eng_notation.call(null,n,new cljs.core.Keyword(null,"sf","sf",-1949491738),sf);var sig = cljs.core.nth.call(null,vec__23695,(0),null);var exp = cljs.core.nth.call(null,vec__23695,(1),null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.money.money_suffix.call(null,exp);if((exp >= (0)))
...
var p__23691 = null;if (arguments.length > 1) {
  p__23691 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return readable__delegate.call(this,n,p__23691);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__23696){
var n = cljs.core.first(arglist__23696);
var p__23691 = cljs.core.rest(arglist__23696);
return readable__delegate(n,p__23691);
});

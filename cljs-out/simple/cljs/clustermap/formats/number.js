...
div_BANG_.cljs$lang$applyTo = (function (arglist__20270){
var num = cljs.core.first(arglist__20270);
var args = cljs.core.rest(arglist__20270);
...
_STAR__BANG_.cljs$lang$applyTo = (function (arglist__20271){
var args = cljs.core.seq(arglist__20271);
...
_PLUS__BANG_.cljs$lang$applyTo = (function (arglist__20272){
...
__BANG_.cljs$lang$applyTo = (function (arglist__20273){
var num = cljs.core.first(arglist__20273);
...
return (function (p__20280){var vec__20281 = p__20280;var i = cljs.core.nth.call(null,vec__20281,(0),null);var v = cljs.core.nth.call(null,vec__20281,(1),null);if((n <= v))
{return i;
} else
{return null;
}
...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__20282_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__20282_SHARP_);
...
var p__20283 = null;if (arguments.length > 1) {
  p__20283 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return eng_notation__delegate.call(this,n,p__20283);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__20292){
var n = cljs.core.first(arglist__20292);
var p__20283 = cljs.core.rest(arglist__20292);
return eng_notation__delegate(n,p__20283);
});
...
var readable__2 = (function (n,p__20293){var map__20296 = p__20293;var map__20296__$1 = ((cljs.core.seq_QMARK_.call(null,map__20296))?cljs.core.apply.call(null,cljs.core.hash_map,map__20296):map__20296);var default$ = cljs.core.get.call(null,map__20296__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");var curr = cljs.core.get.call(null,map__20296__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20296__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var dec = cljs.core.get.call(null,map__20296__$1,new cljs.core.Keyword(null,"dec","dec",1888433436),(0));if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(round_n));var vec__20297 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__20297,(0),null);var d_str = cljs.core.nth.call(null,vec__20297,(1),null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3627__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3627__auto__))
{return (n > (0));
} else
{return and__3627__auto__;
}
...
readable = function(n,p__20293){
switch(arguments.length){
case 1:
return readable__1.call(this,n);
case 2:
return readable__2.call(this,n,p__20293);
}
...
var eng_readable__2 = (function (n,p__20298){var map__20301 = p__20298;var map__20301__$1 = ((cljs.core.seq_QMARK_.call(null,map__20301))?cljs.core.apply.call(null,cljs.core.hash_map,map__20301):map__20301);var sf = cljs.core.get.call(null,map__20301__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738),(3));var curr = cljs.core.get.call(null,map__20301__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20301__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var default$ = cljs.core.get.call(null,map__20301__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{var vec__20302 = clustermap.formats.number.eng_notation.call(null,n,new cljs.core.Keyword(null,"sf","sf",-1949491738),sf);var sig = cljs.core.nth.call(null,vec__20302,(0),null);var exp = cljs.core.nth.call(null,vec__20302,(1),null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.number.eng_suffix.call(null,exp);return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3627__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3627__auto__))
{return (sig > (0));
} else
{return and__3627__auto__;
}
...
eng_readable = function(n,p__20298){
switch(arguments.length){
case 1:
return eng_readable__1.call(this,n);
case 2:
return eng_readable__2.call(this,n,p__20298);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var mixed__2 = (function (n,p__20303){var map__20305 = p__20303;var map__20305__$1 = ((cljs.core.seq_QMARK_.call(null,map__20305))?cljs.core.apply.call(null,cljs.core.hash_map,map__20305):map__20305);var opts = map__20305__$1;var sf = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738),(3));var threshold = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"threshold","threshold",204221583),(1000000));var dec = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"dec","dec",1888433436),(0));var curr = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var default$ = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{if((n < threshold))
...
mixed = function(n,p__20303){
switch(arguments.length){
case 1:
return mixed__1.call(this,n);
case 2:
return mixed__2.call(this,n,p__20303);
}
throw(new Error('Invalid arity: ' + arguments.length));
};

...
div_BANG_.cljs$lang$applyTo = (function (arglist__20275){
var num = cljs.core.first(arglist__20275);
...
_STAR__BANG_.cljs$lang$applyTo = (function (arglist__20276){
var args = cljs.core.seq(arglist__20276);
...
_PLUS__BANG_.cljs$lang$applyTo = (function (arglist__20277){
...
__BANG_.cljs$lang$applyTo = (function (arglist__20278){
var num = cljs.core.first(arglist__20278);
var args = cljs.core.rest(arglist__20278);
...
return (function (p__20285){var vec__20286 = p__20285;var i = cljs.core.nth.call(null,vec__20286,(0),null);var v = cljs.core.nth.call(null,vec__20286,(1),null);if((n <= v))
{return i;
} else
{return null;
}
...
var table_chooser_fn__3 = (function (table,vals,p__20287){var map__20293 = p__20287;var map__20293__$1 = ((cljs.core.seq_QMARK_.call(null,map__20293))?cljs.core.apply.call(null,cljs.core.hash_map,map__20293):map__20293);var default$ = cljs.core.get.call(null,map__20293__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var vals__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.sort.call(null,vals));var c = cljs.core.count.call(null,vals__$1);var idxs = cljs.core.map.call(null,((function (vals__$1,c,map__20293,map__20293__$1,default$){
return (function (tv){return ((tv * c) | (0));
});})(vals__$1,c,map__20293,map__20293__$1,default$))
,cljs.core.sort.call(null,table));var ts = cljs.core.map.call(null,((function (vals__$1,c,idxs,map__20293,map__20293__$1,default$){
return (function (idx){return cljs.core.get.call(null,vals__$1,idx);
});})(vals__$1,c,idxs,map__20293,map__20293__$1,default$))
,idxs);var i_ts = cljs.core.keep_indexed.call(null,cljs.core.vector,ts);return ((function (vals__$1,c,idxs,ts,i_ts,map__20293,map__20293__$1,default$){
return (function (val){if(cljs.core.truth_(val))
{var or__3639__auto__ = cljs.core.some.call(null,((function (vals__$1,c,idxs,ts,i_ts,map__20293,map__20293__$1,default$){
return (function (p__20296){var vec__20297 = p__20296;var i = cljs.core.nth.call(null,vec__20297,(0),null);var t = cljs.core.nth.call(null,vec__20297,(1),null);if((val < t))
{return i;
} else
{return null;
}
});})(vals__$1,c,idxs,ts,i_ts,map__20293,map__20293__$1,default$))
...
table_chooser_fn = function(table,vals,p__20287){
switch(arguments.length){
case 2:
return table_chooser_fn__2.call(this,table,vals);
case 3:
return table_chooser_fn__3.call(this,table,vals,p__20287);
}
...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__20298_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__20298_SHARP_);
...
var p__20299 = null;if (arguments.length > 1) {
  p__20299 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return eng_notation__delegate.call(this,n,p__20299);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__20308){
var n = cljs.core.first(arglist__20308);
var p__20299 = cljs.core.rest(arglist__20308);
return eng_notation__delegate(n,p__20299);
});
...
var readable__2 = (function (n,p__20309){var map__20312 = p__20309;var map__20312__$1 = ((cljs.core.seq_QMARK_.call(null,map__20312))?cljs.core.apply.call(null,cljs.core.hash_map,map__20312):map__20312);var default$ = cljs.core.get.call(null,map__20312__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");var curr = cljs.core.get.call(null,map__20312__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20312__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var dec = cljs.core.get.call(null,map__20312__$1,new cljs.core.Keyword(null,"dec","dec",1888433436),(0));if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(round_n));var vec__20313 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__20313,(0),null);var d_str = cljs.core.nth.call(null,vec__20313,(1),null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3627__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3627__auto__))
{return (n > (0));
} else
{return and__3627__auto__;
}
...
readable = function(n,p__20309){
switch(arguments.length){
case 1:
return readable__1.call(this,n);
case 2:
return readable__2.call(this,n,p__20309);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var eng_readable__2 = (function (n,p__20314){var map__20317 = p__20314;var map__20317__$1 = ((cljs.core.seq_QMARK_.call(null,map__20317))?cljs.core.apply.call(null,cljs.core.hash_map,map__20317):map__20317);var sf = cljs.core.get.call(null,map__20317__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738),(3));var curr = cljs.core.get.call(null,map__20317__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20317__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var default$ = cljs.core.get.call(null,map__20317__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{var vec__20318 = clustermap.formats.number.eng_notation.call(null,n,new cljs.core.Keyword(null,"sf","sf",-1949491738),sf);var sig = cljs.core.nth.call(null,vec__20318,(0),null);var exp = cljs.core.nth.call(null,vec__20318,(1),null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.number.eng_suffix.call(null,exp);return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3627__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3627__auto__))
{return (sig > (0));
} else
{return and__3627__auto__;
}
...
eng_readable = function(n,p__20314){
switch(arguments.length){
case 1:
return eng_readable__1.call(this,n);
case 2:
return eng_readable__2.call(this,n,p__20314);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var mixed__2 = (function (n,p__20319){var map__20321 = p__20319;var map__20321__$1 = ((cljs.core.seq_QMARK_.call(null,map__20321))?cljs.core.apply.call(null,cljs.core.hash_map,map__20321):map__20321);var opts = map__20321__$1;var sf = cljs.core.get.call(null,map__20321__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738),(3));var threshold = cljs.core.get.call(null,map__20321__$1,new cljs.core.Keyword(null,"threshold","threshold",204221583),(1000000));var dec = cljs.core.get.call(null,map__20321__$1,new cljs.core.Keyword(null,"dec","dec",1888433436),(0));var curr = cljs.core.get.call(null,map__20321__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20321__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var default$ = cljs.core.get.call(null,map__20321__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{if((n < threshold))
...
mixed = function(n,p__20319){
switch(arguments.length){
case 1:
return mixed__1.call(this,n);
case 2:
return mixed__2.call(this,n,p__20319);
}
throw(new Error('Invalid arity: ' + arguments.length));
};

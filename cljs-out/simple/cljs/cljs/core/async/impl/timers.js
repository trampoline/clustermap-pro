...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_27373 = (0);while(true){
if((i_27373 < arr.length))
{(arr[i_27373] = null);
{
...
{var i_27380 = (self__.level + (1));while(true){
if((i_27380 <= (new_level + (1))))
{(update[i_27380] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_27382 = (0);while(true){
if((i_27382 <= self__.level))
{var links_27383 = (update[i_27382]).forward;if(((links_27383[i_27382]) === x__$1))
{(links_27383[i_27382] = (x__$1.forward[i_27382]));
{
var G__27384 = (i_27382 + (1));
i_27382 = G__27384;
continue;
}
} else
{{
var G__27385 = (i_27382 + (1));
i_27382 = G__27385;
continue;
}
}

...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_26207 = (0);while(true){
if((i_26207 < arr.length))
{(arr[i_26207] = null);
{
var G__26208 = (i_26207 + (1));
i_26207 = G__26208;
continue;
}
} else
...
{var i_26214 = (self__.level + (1));while(true){
if((i_26214 <= (new_level + (1))))
{(update[i_26214] = self__.header);
{
var G__26215 = (i_26214 + (1));
i_26214 = G__26215;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26216 = (0);while(true){
if((i_26216 <= self__.level))
{var links_26217 = (update[i_26216]).forward;if(((links_26217[i_26216]) === x__$1))
{(links_26217[i_26216] = (x__$1.forward[i_26216]));
{
var G__26218 = (i_26216 + (1));
i_26216 = G__26218;
continue;
}
} else
{{
var G__26219 = (i_26216 + (1));
i_26216 = G__26219;
continue;
}
}

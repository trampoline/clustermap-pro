...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t27733 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t27733 = (function (val,box,meta27734){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t27733.cljs$lang$type = true;
cljs.core.async.impl.channels.t27733.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t27733";
cljs.core.async.impl.channels.t27733.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t27733");
});
cljs.core.async.impl.channels.t27733.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t27733.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27735){var self__ = this;
var _27735__$1 = this;return self__.meta27734;
});
cljs.core.async.impl.channels.t27733.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27735,meta27734__$1){var self__ = this;
var _27735__$1 = this;return (new cljs.core.async.impl.channels.t27733(self__.val,self__.box,meta27734__$1));
});
cljs.core.async.impl.channels.__GT_t27733 = (function __GT_t27733(val__$1,box__$1,meta27734){return (new cljs.core.async.impl.channels.t27733(val__$1,box__$1,meta27734));
});
}
return (new cljs.core.async.impl.channels.t27733(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj27737 = {};return obj27737;
})();
...
{}
while(true){
var taker_27738 = self__.takes.pop();if((taker_27738 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27738))
{var take_cb_27739 = cljs.core.async.impl.protocols.commit.call(null,taker_27738);var val_27740 = (cljs.core.truth_((function (){var and__3627__auto__ = self__.buf;if(cljs.core.truth_(and__3627__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3627__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27739,val_27740,taker_27738,this$__$1){
return (function (){return take_cb_27739.call(null,val_27740);
});})(take_cb_27739,val_27740,taker_27738,this$__$1))
);
} else
{}
{
...
{} else
{var putter_27741 = self__.puts.pop();if((putter_27741 == null))
{} else
{var put_handler_27742 = putter_27741.handler;var val_27743 = putter_27741.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_27742))
{var put_cb_27744 = cljs.core.async.impl.protocols.commit.call(null,put_handler_27742);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_27744,put_handler_27742,val_27743,putter_27741,_,retval,this$__$1){
return (function (){return put_cb_27744.call(null,true);
});})(put_cb_27744,put_handler_27742,val_27743,putter_27741,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_27743)))
...
{var taker_27745 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27745))
{var take_cb_27746 = cljs.core.async.impl.protocols.commit.call(null,taker_27745);var val_27747__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27746,val_27747__$1,taker_27745,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_27746.call(null,val_27747__$1);
});})(take_cb_27746,val_27747__$1,taker_27745,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_27748 = self__.puts.pop();if((putter_27748 == null))
{} else
{var put_handler_27749 = putter_27748.handler;var val_27750 = putter_27748.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_27749))
{var put_cb_27751 = cljs.core.async.impl.protocols.commit.call(null,put_handler_27749);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_27751,put_handler_27749,val_27750,putter_27748,this$__$1){
return (function (){return put_cb_27751.call(null,true);
});})(put_cb_27751,put_handler_27749,val_27750,putter_27748,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__27756 = null;
var G__27756__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e27754){var t = e27754;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__27756__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e27755){var t = e27755;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__27756 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__27756__1.call(this,buf__$1);
case 2:
return G__27756__2.call(this,buf__$1,val);
}

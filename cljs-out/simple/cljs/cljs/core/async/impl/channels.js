...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t27649 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t27649 = (function (val,box,meta27650){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t27649.cljs$lang$type = true;
cljs.core.async.impl.channels.t27649.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t27649";
cljs.core.async.impl.channels.t27649.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t27649");
});
cljs.core.async.impl.channels.t27649.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t27649.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27651){var self__ = this;
var _27651__$1 = this;return self__.meta27650;
});
cljs.core.async.impl.channels.t27649.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27651,meta27650__$1){var self__ = this;
var _27651__$1 = this;return (new cljs.core.async.impl.channels.t27649(self__.val,self__.box,meta27650__$1));
});
cljs.core.async.impl.channels.__GT_t27649 = (function __GT_t27649(val__$1,box__$1,meta27650){return (new cljs.core.async.impl.channels.t27649(val__$1,box__$1,meta27650));
});
}
return (new cljs.core.async.impl.channels.t27649(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj27653 = {};return obj27653;
})();
...
{}
while(true){
var taker_27654 = self__.takes.pop();if((taker_27654 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27654))
{var take_cb_27655 = cljs.core.async.impl.protocols.commit.call(null,taker_27654);var val_27656 = (cljs.core.truth_((function (){var and__3627__auto__ = self__.buf;if(cljs.core.truth_(and__3627__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3627__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27655,val_27656,taker_27654,this$__$1){
return (function (){return take_cb_27655.call(null,val_27656);
});})(take_cb_27655,val_27656,taker_27654,this$__$1))
);
} else
{}
{
...
{} else
{var putter_27657 = self__.puts.pop();if((putter_27657 == null))
{} else
{var put_handler_27658 = putter_27657.handler;var val_27659 = putter_27657.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_27658))
{var put_cb_27660 = cljs.core.async.impl.protocols.commit.call(null,put_handler_27658);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_27660,put_handler_27658,val_27659,putter_27657,_,retval,this$__$1){
return (function (){return put_cb_27660.call(null,true);
});})(put_cb_27660,put_handler_27658,val_27659,putter_27657,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_27659)))
...
{var taker_27661 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27661))
{var take_cb_27662 = cljs.core.async.impl.protocols.commit.call(null,taker_27661);var val_27663__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27662,val_27663__$1,taker_27661,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_27662.call(null,val_27663__$1);
});})(take_cb_27662,val_27663__$1,taker_27661,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_27664 = self__.puts.pop();if((putter_27664 == null))
{} else
{var put_handler_27665 = putter_27664.handler;var val_27666 = putter_27664.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_27665))
{var put_cb_27667 = cljs.core.async.impl.protocols.commit.call(null,put_handler_27665);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_27667,put_handler_27665,val_27666,putter_27664,this$__$1){
return (function (){return put_cb_27667.call(null,true);
});})(put_cb_27667,put_handler_27665,val_27666,putter_27664,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__27672 = null;
var G__27672__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e27670){var t = e27670;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__27672__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e27671){var t = e27671;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__27672 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__27672__1.call(this,buf__$1);
case 2:
return G__27672__2.call(this,buf__$1,val);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__27672.cljs$core$IFn$_invoke$arity$1 = G__27672__1;
G__27672.cljs$core$IFn$_invoke$arity$2 = G__27672__2;
return G__27672;
})()
;})(add_BANG_))
})()));

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t27499 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t27499 = (function (val,box,meta27500){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t27499.cljs$lang$type = true;
cljs.core.async.impl.channels.t27499.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t27499";
cljs.core.async.impl.channels.t27499.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t27499");
});
cljs.core.async.impl.channels.t27499.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t27499.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27501){var self__ = this;
var _27501__$1 = this;return self__.meta27500;
});
cljs.core.async.impl.channels.t27499.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27501,meta27500__$1){var self__ = this;
var _27501__$1 = this;return (new cljs.core.async.impl.channels.t27499(self__.val,self__.box,meta27500__$1));
});
cljs.core.async.impl.channels.__GT_t27499 = (function __GT_t27499(val__$1,box__$1,meta27500){return (new cljs.core.async.impl.channels.t27499(val__$1,box__$1,meta27500));
});
}
return (new cljs.core.async.impl.channels.t27499(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj27503 = {};return obj27503;
})();
...
{}
while(true){
var taker_27504 = self__.takes.pop();if((taker_27504 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27504))
{var take_cb_27505 = cljs.core.async.impl.protocols.commit.call(null,taker_27504);var val_27506 = (cljs.core.truth_((function (){var and__3627__auto__ = self__.buf;if(cljs.core.truth_(and__3627__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3627__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27505,val_27506,taker_27504,this$__$1){
return (function (){return take_cb_27505.call(null,val_27506);
});})(take_cb_27505,val_27506,taker_27504,this$__$1))
);
} else
{}
{
...
{} else
{var putter_27507 = self__.puts.pop();if((putter_27507 == null))
{} else
{var put_handler_27508 = putter_27507.handler;var val_27509 = putter_27507.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_27508))
{var put_cb_27510 = cljs.core.async.impl.protocols.commit.call(null,put_handler_27508);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_27510,put_handler_27508,val_27509,putter_27507,_,retval,this$__$1){
return (function (){return put_cb_27510.call(null,true);
});})(put_cb_27510,put_handler_27508,val_27509,putter_27507,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_27509)))
...
{var taker_27511 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27511))
{var take_cb_27512 = cljs.core.async.impl.protocols.commit.call(null,taker_27511);var val_27513__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27512,val_27513__$1,taker_27511,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_27512.call(null,val_27513__$1);
});})(take_cb_27512,val_27513__$1,taker_27511,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_27514 = self__.puts.pop();if((putter_27514 == null))
{} else
{var put_handler_27515 = putter_27514.handler;var val_27516 = putter_27514.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_27515))
{var put_cb_27517 = cljs.core.async.impl.protocols.commit.call(null,put_handler_27515);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_27517,put_handler_27515,val_27516,putter_27514,this$__$1){
return (function (){return put_cb_27517.call(null,true);
});})(put_cb_27517,put_handler_27515,val_27516,putter_27514,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__27522 = null;
var G__27522__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e27520){var t = e27520;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__27522__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e27521){var t = e27521;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__27522 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__27522__1.call(this,buf__$1);
case 2:
return G__27522__2.call(this,buf__$1,val);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__27522.cljs$core$IFn$_invoke$arity$1 = G__27522__1;
G__27522.cljs$core$IFn$_invoke$arity$2 = G__27522__2;
return G__27522;
})()
;})(add_BANG_))
})()));

...
{{
var G__29486 = (i + (1));
var G__29487 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29486;
acc = G__29487;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29491 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29491 = (function (expr,base,xpath,meta29492){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29491.cljs$lang$type = true;
domina.xpath.t29491.cljs$lang$ctorStr = "domina.xpath/t29491";
domina.xpath.t29491.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29491");
});
domina.xpath.t29491.prototype.domina$DomContent$ = true;
domina.xpath.t29491.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29491.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29491.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29493){var self__ = this;
var _29493__$1 = this;return self__.meta29492;
});
domina.xpath.t29491.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29493,meta29492__$1){var self__ = this;
var _29493__$1 = this;return (new domina.xpath.t29491(self__.expr,self__.base,self__.xpath,meta29492__$1));
});
domina.xpath.__GT_t29491 = (function __GT_t29491(expr__$1,base__$1,xpath__$1,meta29492){return (new domina.xpath.t29491(expr__$1,base__$1,xpath__$1,meta29492));
});
}
return (new domina.xpath.t29491(expr,base,xpath,null));
});

...
{{
var G__29355 = (i + (1));
var G__29356 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29355;
acc = G__29356;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29360 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29360 = (function (expr,base,xpath,meta29361){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29360.cljs$lang$type = true;
domina.xpath.t29360.cljs$lang$ctorStr = "domina.xpath/t29360";
domina.xpath.t29360.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29360");
});
domina.xpath.t29360.prototype.domina$DomContent$ = true;
domina.xpath.t29360.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29360.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29360.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29362){var self__ = this;
var _29362__$1 = this;return self__.meta29361;
});
domina.xpath.t29360.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29362,meta29361__$1){var self__ = this;
var _29362__$1 = this;return (new domina.xpath.t29360(self__.expr,self__.base,self__.xpath,meta29361__$1));
});
domina.xpath.__GT_t29360 = (function __GT_t29360(expr__$1,base__$1,xpath__$1,meta29361){return (new domina.xpath.t29360(expr__$1,base__$1,xpath__$1,meta29361));
});
}
return (new domina.xpath.t29360(expr,base,xpath,null));
});

...
{{
var G__29302 = (i + (1));
var G__29303 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29302;
acc = G__29303;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29307 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29307 = (function (expr,base,xpath,meta29308){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29307.cljs$lang$type = true;
domina.xpath.t29307.cljs$lang$ctorStr = "domina.xpath/t29307";
domina.xpath.t29307.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29307");
});
domina.xpath.t29307.prototype.domina$DomContent$ = true;
domina.xpath.t29307.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29307.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29307.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29309){var self__ = this;
var _29309__$1 = this;return self__.meta29308;
});
domina.xpath.t29307.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29309,meta29308__$1){var self__ = this;
var _29309__$1 = this;return (new domina.xpath.t29307(self__.expr,self__.base,self__.xpath,meta29308__$1));
});
domina.xpath.__GT_t29307 = (function __GT_t29307(expr__$1,base__$1,xpath__$1,meta29308){return (new domina.xpath.t29307(expr__$1,base__$1,xpath__$1,meta29308));
});
}
return (new domina.xpath.t29307(expr,base,xpath,null));
});

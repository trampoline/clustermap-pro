...
{{
var G__28196 = (i + (1));
var G__28197 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__28196;
acc = G__28197;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t28201 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t28201 = (function (expr,base,xpath,meta28202){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t28201.cljs$lang$type = true;
domina.xpath.t28201.cljs$lang$ctorStr = "domina.xpath/t28201";
domina.xpath.t28201.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t28201");
});
domina.xpath.t28201.prototype.domina$DomContent$ = true;
domina.xpath.t28201.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28201.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28201.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28203){var self__ = this;
var _28203__$1 = this;return self__.meta28202;
});
domina.xpath.t28201.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28203,meta28202__$1){var self__ = this;
var _28203__$1 = this;return (new domina.xpath.t28201(self__.expr,self__.base,self__.xpath,meta28202__$1));
});
domina.xpath.__GT_t28201 = (function __GT_t28201(expr__$1,base__$1,xpath__$1,meta28202){return (new domina.xpath.t28201(expr__$1,base__$1,xpath__$1,meta28202));
});
}
return (new domina.xpath.t28201(expr,base,xpath,null));
});

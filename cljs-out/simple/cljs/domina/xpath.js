...
{{
var G__28794 = (i + (1));
var G__28795 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__28794;
acc = G__28795;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t28799 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t28799 = (function (expr,base,xpath,meta28800){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t28799.cljs$lang$type = true;
domina.xpath.t28799.cljs$lang$ctorStr = "domina.xpath/t28799";
domina.xpath.t28799.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t28799");
});
domina.xpath.t28799.prototype.domina$DomContent$ = true;
domina.xpath.t28799.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28799.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t28799.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28801){var self__ = this;
var _28801__$1 = this;return self__.meta28800;
});
domina.xpath.t28799.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28801,meta28800__$1){var self__ = this;
var _28801__$1 = this;return (new domina.xpath.t28799(self__.expr,self__.base,self__.xpath,meta28800__$1));
});
domina.xpath.__GT_t28799 = (function __GT_t28799(expr__$1,base__$1,xpath__$1,meta28800){return (new domina.xpath.t28799(expr__$1,base__$1,xpath__$1,meta28800));
});
}
return (new domina.xpath.t28799(expr,base,xpath,null));
});

...
var G__20372 = null;
var G__20372__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__20372__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
G__20372 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__20372__2.call(this,self__,k);
case 3:
return G__20372__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;
jQuery.prototype.apply = (function (self__,args20371){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args20371)));
});
...
var hide__delegate = function ($elem,p__20373){var vec__20375 = p__20373;var speed = cljs.core.nth.call(null,vec__20375,(0),null);var on_finish = cljs.core.nth.call(null,vec__20375,(1),null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__20373 = null;if (arguments.length > 1) {
  p__20373 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__20373);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__20376){
var $elem = cljs.core.first(arglist__20376);
var p__20373 = cljs.core.rest(arglist__20376);
return hide__delegate($elem,p__20373);
});
...
var show__delegate = function ($elem,p__20377){var vec__20379 = p__20377;var speed = cljs.core.nth.call(null,vec__20379,(0),null);var on_finish = cljs.core.nth.call(null,vec__20379,(1),null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__20377 = null;if (arguments.length > 1) {
  p__20377 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__20377);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__20380){
var $elem = cljs.core.first(arglist__20380);
var p__20377 = cljs.core.rest(arglist__20380);
return show__delegate($elem,p__20377);
});
...
var toggle__delegate = function ($elem,p__20381){var vec__20383 = p__20381;var speed = cljs.core.nth.call(null,vec__20383,(0),null);var on_finish = cljs.core.nth.call(null,vec__20383,(1),null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__20381 = null;if (arguments.length > 1) {
  p__20381 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__20381);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__20384){
var $elem = cljs.core.first(arglist__20384);
var p__20381 = cljs.core.rest(arglist__20384);
return toggle__delegate($elem,p__20381);
});
...
var fade_out__delegate = function ($elem,p__20385){var vec__20387 = p__20385;var speed = cljs.core.nth.call(null,vec__20387,(0),null);var on_finish = cljs.core.nth.call(null,vec__20387,(1),null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__20385 = null;if (arguments.length > 1) {
  p__20385 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__20385);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__20388){
var $elem = cljs.core.first(arglist__20388);
var p__20385 = cljs.core.rest(arglist__20388);
return fade_out__delegate($elem,p__20385);
});
...
var fade_in__delegate = function ($elem,p__20389){var vec__20391 = p__20389;var speed = cljs.core.nth.call(null,vec__20391,(0),null);var on_finish = cljs.core.nth.call(null,vec__20391,(1),null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__20389 = null;if (arguments.length > 1) {
  p__20389 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__20389);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__20392){
var $elem = cljs.core.first(arglist__20392);
var p__20389 = cljs.core.rest(arglist__20392);
return fade_in__delegate($elem,p__20389);
});
...
var slide_up__delegate = function ($elem,p__20393){var vec__20395 = p__20393;var speed = cljs.core.nth.call(null,vec__20395,(0),null);var on_finish = cljs.core.nth.call(null,vec__20395,(1),null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__20393 = null;if (arguments.length > 1) {
  p__20393 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__20393);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__20396){
var $elem = cljs.core.first(arglist__20396);
var p__20393 = cljs.core.rest(arglist__20396);
return slide_up__delegate($elem,p__20393);
});
...
var slide_down__delegate = function ($elem,p__20397){var vec__20399 = p__20397;var speed = cljs.core.nth.call(null,vec__20399,(0),null);var on_finish = cljs.core.nth.call(null,vec__20399,(1),null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__20397 = null;if (arguments.length > 1) {
  p__20397 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__20397);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__20400){
var $elem = cljs.core.first(arglist__20400);
var p__20397 = cljs.core.rest(arglist__20400);
return slide_down__delegate($elem,p__20397);
});
...
var closest__delegate = function ($elem,selector,p__20401){var vec__20403 = p__20401;var context = cljs.core.nth.call(null,vec__20403,(0),null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__20401 = null;if (arguments.length > 2) {
  p__20401 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__20401);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__20404){
var $elem = cljs.core.first(arglist__20404);
arglist__20404 = cljs.core.next(arglist__20404);
var selector = cljs.core.first(arglist__20404);
var p__20401 = cljs.core.rest(arglist__20404);
return closest__delegate($elem,selector,p__20401);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__20407){var map__20409 = p__20407;var map__20409__$1 = ((cljs.core.seq_QMARK_.call(null,map__20409))?cljs.core.apply.call(null,cljs.core.hash_map,map__20409):map__20409);var request = map__20409__$1;var contentType = cljs.core.get.call(null,map__20409__$1,new cljs.core.Keyword(null,"contentType","contentType",-1462509576));var data = cljs.core.get.call(null,map__20409__$1,new cljs.core.Keyword(null,"data","data",-232669377));var ct = jayq.core.__GT_content_type.call(null,contentType);return ((function (ct,map__20409,map__20409__$1,request,contentType,data){
return (function (p1__20406_SHARP_){if(cljs.core.truth_((function (){var and__3627__auto__ = ct;if(cljs.core.truth_(and__3627__auto__))
{return jayq.core.clj_content_type_QMARK_.call(null,ct);
} else
{return and__3627__auto__;
}
})()))
{return cljs.core.assoc.call(null,p1__20406_SHARP_,new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.pr_str.call(null,data));
} else
{return p1__20406_SHARP_;
}
});})(ct,map__20409,map__20409__$1,request,contentType,data))
.call(null,((function (ct,map__20409,map__20409__$1,request,contentType,data){
return (function (p1__20405_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__20405_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",-1462509576),ct);
} else
...
var unbind__delegate = function ($elem,ev,p__20413){var vec__20415 = p__20413;var func = cljs.core.nth.call(null,vec__20415,(0),null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__20413 = null;if (arguments.length > 2) {
  p__20413 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__20413);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__20416){
var $elem = cljs.core.first(arglist__20416);
arglist__20416 = cljs.core.next(arglist__20416);
var ev = cljs.core.first(arglist__20416);
var p__20413 = cljs.core.rest(arglist__20416);
return unbind__delegate($elem,ev,p__20413);
});
...
var on__delegate = function ($elem,events,p__20417){var vec__20419 = p__20417;var sel = cljs.core.nth.call(null,vec__20419,(0),null);var data = cljs.core.nth.call(null,vec__20419,(1),null);var handler = cljs.core.nth.call(null,vec__20419,(2),null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__20417 = null;if (arguments.length > 2) {
  p__20417 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__20417);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__20420){
var $elem = cljs.core.first(arglist__20420);
arglist__20420 = cljs.core.next(arglist__20420);
var events = cljs.core.first(arglist__20420);
var p__20417 = cljs.core.rest(arglist__20420);
return on__delegate($elem,events,p__20417);
});
...
var one__delegate = function ($elem,events,p__20421){var vec__20423 = p__20421;var sel = cljs.core.nth.call(null,vec__20423,(0),null);var data = cljs.core.nth.call(null,vec__20423,(1),null);var handler = cljs.core.nth.call(null,vec__20423,(2),null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__20421 = null;if (arguments.length > 2) {
  p__20421 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__20421);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__20424){
var $elem = cljs.core.first(arglist__20424);
arglist__20424 = cljs.core.next(arglist__20424);
var events = cljs.core.first(arglist__20424);
var p__20421 = cljs.core.rest(arglist__20424);
return one__delegate($elem,events,p__20421);
});
...
var off__delegate = function ($elem,events,p__20425){var vec__20427 = p__20425;var sel = cljs.core.nth.call(null,vec__20427,(0),null);var handler = cljs.core.nth.call(null,vec__20427,(1),null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__20425 = null;if (arguments.length > 2) {
  p__20425 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__20425);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__20428){
var $elem = cljs.core.first(arglist__20428);
arglist__20428 = cljs.core.next(arglist__20428);
var events = cljs.core.first(arglist__20428);
var p__20425 = cljs.core.rest(arglist__20428);
return off__delegate($elem,events,p__20425);
});
...
done.cljs$lang$applyTo = (function (arglist__20429){
var deferred = cljs.core.first(arglist__20429);
var fns_args = cljs.core.rest(arglist__20429);
...
fail.cljs$lang$applyTo = (function (arglist__20430){
var deferred = cljs.core.first(arglist__20430);
var fns_args = cljs.core.rest(arglist__20430);
...
always.cljs$lang$applyTo = (function (arglist__20431){
var deferred = cljs.core.first(arglist__20431);
var fns_args = cljs.core.rest(arglist__20431);

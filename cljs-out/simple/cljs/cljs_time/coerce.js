...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj27562 = {};return obj27562;
})();
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__27564 = (new goog.date.UtcDateTime());G__27564.setTime(millis);
return G__27564;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__4377__auto__ = (function iter__27573(s__27574){return (new cljs.core.LazySeq(null,(function (){var s__27574__$1 = s__27574;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__27574__$1);if(temp__4126__auto__)
{var s__27574__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__27574__$2))
{var c__4375__auto__ = cljs.core.chunk_first.call(null,s__27574__$2);var size__4376__auto__ = cljs.core.count.call(null,c__4375__auto__);var b__27576 = cljs.core.chunk_buffer.call(null,size__4376__auto__);if((function (){var i__27575 = (0);while(true){
if((i__27575 < size__4376__auto__))
{var f = cljs.core._nth.call(null,c__4375__auto__,i__27575);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27579){if((e27579 instanceof Error))
{var _ = e27579;return null;
} else
{throw e27579;

}
}})();if(cljs.core.truth_(d))
{cljs.core.chunk_append.call(null,b__27576,d);
{
var G__27581 = (i__27575 + (1));
i__27575 = G__27581;
continue;
}
} else
{{
var G__27582 = (i__27575 + (1));
i__27575 = G__27582;
continue;
}
}
...
{var f = cljs.core.first.call(null,s__27574__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27580){if((e27580 instanceof Error))
{var _ = e27580;return null;
} else
{throw e27580;

}
}})();if(cljs.core.truth_(d))
{return cljs.core.cons.call(null,d,iter__27573.call(null,cljs.core.rest.call(null,s__27574__$2)));
} else
{{
var G__27583 = cljs.core.rest.call(null,s__27574__$2);
s__27574__$1 = G__27583;
continue;
}
}
}
...
{var dt = temp__4124__auto__;var G__27585 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__27585.setHours(dt.getHours());
G__27585.setMinutes(dt.getMinutes());
G__27585.setSeconds(dt.getSeconds());
G__27585.setMilliseconds(dt.getMilliseconds());
return G__27585;
} else
{return null;
}

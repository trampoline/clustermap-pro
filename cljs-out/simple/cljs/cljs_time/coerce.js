...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj27672 = {};return obj27672;
})();
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__27674 = (new goog.date.UtcDateTime());G__27674.setTime(millis);
return G__27674;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__4377__auto__ = (function iter__27683(s__27684){return (new cljs.core.LazySeq(null,(function (){var s__27684__$1 = s__27684;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__27684__$1);if(temp__4126__auto__)
{var s__27684__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__27684__$2))
{var c__4375__auto__ = cljs.core.chunk_first.call(null,s__27684__$2);var size__4376__auto__ = cljs.core.count.call(null,c__4375__auto__);var b__27686 = cljs.core.chunk_buffer.call(null,size__4376__auto__);if((function (){var i__27685 = (0);while(true){
if((i__27685 < size__4376__auto__))
{var f = cljs.core._nth.call(null,c__4375__auto__,i__27685);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27689){if((e27689 instanceof Error))
{var _ = e27689;return null;
} else
{throw e27689;

}
}})();if(cljs.core.truth_(d))
{cljs.core.chunk_append.call(null,b__27686,d);
{
var G__27691 = (i__27685 + (1));
i__27685 = G__27691;
continue;
}
} else
{{
var G__27692 = (i__27685 + (1));
i__27685 = G__27692;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__27686),iter__27683.call(null,cljs.core.chunk_rest.call(null,s__27684__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__27686),null);
}
} else
{var f = cljs.core.first.call(null,s__27684__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27690){if((e27690 instanceof Error))
{var _ = e27690;return null;
} else
{throw e27690;

}
}})();if(cljs.core.truth_(d))
{return cljs.core.cons.call(null,d,iter__27683.call(null,cljs.core.rest.call(null,s__27684__$2)));
} else
{{
var G__27693 = cljs.core.rest.call(null,s__27684__$2);
s__27684__$1 = G__27693;
continue;
}
}
}
...
{var dt = temp__4124__auto__;var G__27695 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__27695.setHours(dt.getHours());
G__27695.setMinutes(dt.getMinutes());
G__27695.setSeconds(dt.getSeconds());
G__27695.setMilliseconds(dt.getMilliseconds());
return G__27695;
} else
{return null;
}

...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj27565 = {};return obj27565;
})();
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__27567 = (new goog.date.UtcDateTime());G__27567.setTime(millis);
return G__27567;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__4377__auto__ = (function iter__27576(s__27577){return (new cljs.core.LazySeq(null,(function (){var s__27577__$1 = s__27577;while(true){
...
{var f = cljs.core._nth.call(null,c__4375__auto__,i__27578);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
...
{var f = cljs.core.first.call(null,s__27577__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
...
{var dt = temp__4124__auto__;var G__27588 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__27588.setHours(dt.getHours());
G__27588.setMinutes(dt.getMinutes());
G__27588.setSeconds(dt.getSeconds());
G__27588.setMilliseconds(dt.getMilliseconds());
return G__27588;
} else
{return null;
}

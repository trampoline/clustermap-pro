...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj27567 = {};return obj27567;
})();
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__27569 = (new goog.date.UtcDateTime());G__27569.setTime(millis);
return G__27569;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__4377__auto__ = (function iter__27578(s__27579){return (new cljs.core.LazySeq(null,(function (){var s__27579__$1 = s__27579;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__27579__$1);if(temp__4126__auto__)
{var s__27579__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__27579__$2))
{var c__4375__auto__ = cljs.core.chunk_first.call(null,s__27579__$2);var size__4376__auto__ = cljs.core.count.call(null,c__4375__auto__);var b__27581 = cljs.core.chunk_buffer.call(null,size__4376__auto__);if((function (){var i__27580 = (0);while(true){
if((i__27580 < size__4376__auto__))
{var f = cljs.core._nth.call(null,c__4375__auto__,i__27580);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27584){if((e27584 instanceof Error))
{var _ = e27584;return null;
} else
{throw e27584;

}
}})();if(cljs.core.truth_(d))
{cljs.core.chunk_append.call(null,b__27581,d);
{
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__27581),iter__27578.call(null,cljs.core.chunk_rest.call(null,s__27579__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__27581),null);
}
} else
{var f = cljs.core.first.call(null,s__27579__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27585){if((e27585 instanceof Error))
{var _ = e27585;return null;
} else
{throw e27585;

}
}})();if(cljs.core.truth_(d))
{return cljs.core.cons.call(null,d,iter__27578.call(null,cljs.core.rest.call(null,s__27579__$2)));
} else
{{
var G__27588 = cljs.core.rest.call(null,s__27579__$2);
s__27579__$1 = G__27588;
continue;
}
}
}
...
{var dt = temp__4124__auto__;var G__27590 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__27590.setHours(dt.getHours());
G__27590.setMinutes(dt.getMinutes());
G__27590.setSeconds(dt.getSeconds());
G__27590.setMilliseconds(dt.getMilliseconds());
return G__27590;
} else
{return null;
}

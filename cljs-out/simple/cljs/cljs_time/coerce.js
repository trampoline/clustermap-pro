...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj27458 = {};return obj27458;
})();
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__27460 = (new goog.date.UtcDateTime());G__27460.setTime(millis);
return G__27460;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__4377__auto__ = (function iter__27469(s__27470){return (new cljs.core.LazySeq(null,(function (){var s__27470__$1 = s__27470;while(true){
...
{var f = cljs.core._nth.call(null,c__4375__auto__,i__27471);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
...
{var f = cljs.core.first.call(null,s__27470__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
...
{var dt = temp__4124__auto__;var G__27481 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__27481.setHours(dt.getHours());
G__27481.setMinutes(dt.getMinutes());
G__27481.setSeconds(dt.getSeconds());
G__27481.setMilliseconds(dt.getMilliseconds());
return G__27481;
} else
{return null;
}

...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj39152 = {};return obj39152;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__11540__auto__ = this$;if(and__11540__auto__)
...
{var x__12188__auto__ = (((this$ == null))?null:this$);return (function (){var or__11552__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__12188__auto__)]);if(or__11552__auto__)
{return or__11552__auto__;
} else
{var or__11552__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__11552__auto____$1)
...
return (function (p__39153){var vec__39154 = p__39153;var k = cljs.core.nth.call(null,vec__39154,(0),null);var v = cljs.core.nth.call(null,vec__39154,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__39155){var vec__39156 = p__39155;var k = cljs.core.nth.call(null,vec__39156,(0),null);var v = cljs.core.nth.call(null,vec__39156,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else

...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj33626 = {};return obj33626;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__11502__auto__ = this$;if(and__11502__auto__)
...
{var x__12150__auto__ = (((this$ == null))?null:this$);return (function (){var or__11514__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__12150__auto__)]);if(or__11514__auto__)
{return or__11514__auto__;
} else
{var or__11514__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__11514__auto____$1)
...
return (function (p__33627){var vec__33628 = p__33627;var k = cljs.core.nth.call(null,vec__33628,(0),null);var v = cljs.core.nth.call(null,vec__33628,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__33629){var vec__33630 = p__33629;var k = cljs.core.nth.call(null,vec__33630,(0),null);var v = cljs.core.nth.call(null,vec__33630,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else

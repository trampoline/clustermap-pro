...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj39289 = {};return obj39289;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__11540__auto__ = this$;if(and__11540__auto__)
...
{var x__12188__auto__ = (((this$ == null))?null:this$);return (function (){var or__11552__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__12188__auto__)]);if(or__11552__auto__)
{return or__11552__auto__;
} else
{var or__11552__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__11552__auto____$1)
...
return (function (p__39290){var vec__39291 = p__39290;var k = cljs.core.nth.call(null,vec__39291,(0),null);var v = cljs.core.nth.call(null,vec__39291,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))

...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj33763 = {};return obj33763;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__11502__auto__ = this$;if(and__11502__auto__)
...
{var x__12150__auto__ = (((this$ == null))?null:this$);return (function (){var or__11514__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__12150__auto__)]);if(or__11514__auto__)
{return or__11514__auto__;
} else
{var or__11514__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__11514__auto____$1)
...
return (function (p__33764){var vec__33765 = p__33764;var k = cljs.core.nth.call(null,vec__33765,(0),null);var v = cljs.core.nth.call(null,vec__33765,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))

...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj40838 = {};return obj40838;
})();
cljs_time.coerce.to_date_time = (function to_date_time(obj){if((function (){var and__11540__auto__ = obj;if(and__11540__auto__)
...
{var x__12188__auto__ = (((obj == null))?null:obj);return (function (){var or__11552__auto__ = (cljs_time.coerce.to_date_time[goog.typeOf(x__12188__auto__)]);if(or__11552__auto__)
{return or__11552__auto__;
} else
{var or__11552__auto____$1 = (cljs_time.coerce.to_date_time["_"]);if(or__11552__auto____$1)
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__40840 = (new goog.date.UtcDateTime());G__40840.setTime(millis);
return G__40840;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__12290__auto__ = (function iter__40849(s__40850){return (new cljs.core.LazySeq(null,(function (){var s__40850__$1 = s__40850;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__40850__$1);if(temp__4126__auto__)
{var s__40850__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__40850__$2))
{var c__12288__auto__ = cljs.core.chunk_first.call(null,s__40850__$2);var size__12289__auto__ = cljs.core.count.call(null,c__12288__auto__);var b__40852 = cljs.core.chunk_buffer.call(null,size__12289__auto__);if((function (){var i__40851 = (0);while(true){
if((i__40851 < size__12289__auto__))
{var f = cljs.core._nth.call(null,c__12288__auto__,i__40851);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e40855){if((e40855 instanceof Error))
{var _ = e40855;return null;
} else
{throw e40855;

}
}})();if(cljs.core.truth_(d))
{cljs.core.chunk_append.call(null,b__40852,d);
{
var G__40857 = (i__40851 + (1));
i__40851 = G__40857;
continue;
}
} else
{{
var G__40858 = (i__40851 + (1));
i__40851 = G__40858;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__40852),iter__40849.call(null,cljs.core.chunk_rest.call(null,s__40850__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__40852),null);
}
} else
{var f = cljs.core.first.call(null,s__40850__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e40856){if((e40856 instanceof Error))
{var _ = e40856;return null;
} else
{throw e40856;

}
}})();if(cljs.core.truth_(d))
{return cljs.core.cons.call(null,d,iter__40849.call(null,cljs.core.rest.call(null,s__40850__$2)));
} else
{{
var G__40859 = cljs.core.rest.call(null,s__40850__$2);
s__40850__$1 = G__40859;
continue;
}
}
}
...
*/
cljs_time.coerce.to_epoch = (function to_epoch(obj){var millis = cljs_time.coerce.to_long.call(null,obj);var and__11540__auto__ = millis;if(cljs.core.truth_(and__11540__auto__))
{return (millis / (1000));
} else
{return and__11540__auto__;
}
...
{var dt = temp__4124__auto__;var G__40861 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__40861.setHours(dt.getHours());
G__40861.setMinutes(dt.getMinutes());
G__40861.setSeconds(dt.getSeconds());
G__40861.setMilliseconds(dt.getMilliseconds());
return G__40861;
} else
{return null;
}

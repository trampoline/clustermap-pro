...
sablono.util.ToString = (function (){var obj33090 = {};return obj33090;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__11502__auto__ = x;if(and__11502__auto__)
...
{var x__12150__auto__ = (((x == null))?null:x);return (function (){var or__11514__auto__ = (sablono.util.to_str[goog.typeOf(x__12150__auto__)]);if(or__11514__auto__)
{return or__11514__auto__;
} else
{var or__11514__auto____$1 = (sablono.util.to_str["_"]);if(or__11514__auto____$1)
...
sablono.util.ToURI = (function (){var obj33092 = {};return obj33092;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__11502__auto__ = x;if(and__11502__auto__)
...
{var x__12150__auto__ = (((x == null))?null:x);return (function (){var or__11514__auto__ = (sablono.util.to_uri[goog.typeOf(x__12150__auto__)]);if(or__11514__auto__)
{return or__11514__auto__;
} else
{var or__11514__auto____$1 = (sablono.util.to_uri["_"]);if(or__11514__auto____$1)
{return or__11514__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__33093){
var xs = cljs.core.seq(arglist__33093);
...
{var vec__33095 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__33095,(0),null);var words = cljs.core.nthnext.call(null,vec__33095,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__33097 = clojure.set.rename_keys.call(null,m,kmap);var G__33097__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__33097,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__33097);return G__33097__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__33098_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__33098_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__33098_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__33098_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__33099){
var maps = cljs.core.seq(arglist__33099);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__33103 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));var tag_name = cljs.core.nth.call(null,vec__33103,(0),null);var names = cljs.core.nth.call(null,vec__33103,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__33103,tag_name,names){
return (function (p1__33100_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__33100_SHARP_));
});})(matches,vec__33103,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__33103,tag_name,names){
return (function (p1__33101_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__33101_SHARP_));
});})(matches,vec__33103,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__33104){var vec__33107 = p__33104;var tag = cljs.core.nth.call(null,vec__33107,(0),null);var content = cljs.core.nthnext.call(null,vec__33107,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__11514__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__11514__auto__))
{return or__11514__auto__;
} else

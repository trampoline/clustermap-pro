...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__12128__auto__,writer__12129__auto__,opt__12130__auto__){return cljs.core._write.call(null,writer__12129__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_38418 = (0);while(true){
if((i_38418 < arr.length))
{(arr[i_38418] = null);
{
var G__38419 = (i_38418 + (1));
i_38418 = G__38419;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__12128__auto__,writer__12129__auto__,opt__12130__auto__){return cljs.core._write.call(null,writer__12129__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_38425 = (self__.level + (1));while(true){
if((i_38425 <= (new_level + (1))))
{(update[i_38425] = self__.header);
{
var G__38426 = (i_38425 + (1));
i_38425 = G__38426;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_38427 = (0);while(true){
if((i_38427 <= self__.level))
{var links_38428 = (update[i_38427]).forward;if(((links_38428[i_38427]) === x__$1))
{(links_38428[i_38427] = (x__$1.forward[i_38427]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__11552__auto__ = (cljs.core.truth_((function (){var and__11540__auto__ = me;if(cljs.core.truth_(and__11540__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__11540__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__11552__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__11552__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__11552__auto__,timeout__$1,me))
,msecs);

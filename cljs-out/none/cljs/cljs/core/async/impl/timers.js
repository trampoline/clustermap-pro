...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__12090__auto__,writer__12091__auto__,opt__12092__auto__){return cljs.core._write.call(null,writer__12091__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_36855 = (0);while(true){
if((i_36855 < arr.length))
{(arr[i_36855] = null);
{
var G__36856 = (i_36855 + (1));
i_36855 = G__36856;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__12090__auto__,writer__12091__auto__,opt__12092__auto__){return cljs.core._write.call(null,writer__12091__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_36862 = (self__.level + (1));while(true){
if((i_36862 <= (new_level + (1))))
{(update[i_36862] = self__.header);
{
var G__36863 = (i_36862 + (1));
i_36862 = G__36863;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_36864 = (0);while(true){
if((i_36864 <= self__.level))
{var links_36865 = (update[i_36864]).forward;if(((links_36865[i_36864]) === x__$1))
{(links_36865[i_36864] = (x__$1.forward[i_36864]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__11514__auto__ = (cljs.core.truth_((function (){var and__11502__auto__ = me;if(cljs.core.truth_(and__11502__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__11502__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__11514__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__11514__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__11514__auto__,timeout__$1,me))
,msecs);
